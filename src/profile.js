...
export function Profile() {
    return(
        ...
        <img src={mypic} className={clss.pic}></img>
            ...
            <SkillBar name="PYTHON" level={70} color="#494A41" />
            <SkillBar name="NODE JS" level={40} color="#3E3F38" />
            <SkillBar name="REST API" level={40} color="#3E3F38" />
            <SkillBar name="Express Js" level={40} color="#3E3F38" />
            <SkillBar name="GIT" level={40} color="#3E3F38" />
            </div>
            </aside>
